...
window.tracks = [ { src: 'https://www.dropbox.com/scl/fi/x0z9ddkz3zfqrvcnb6nr8/Odysea-Kapit-na-Ar-era-1.mp3?rlkey=mlav41qi6qe5ukss3q4qdd8f6&st=44y26ef2&dl=1', title: 'Odysea-Kapitána-Arčra', duration: '02:12' },
...
/*window.CaptainToSyncBridge = {
    // Funkce, kterou kapitán zavolá po KAŽDÉ změně dat (přejmenování, přidání)
    notifyDataChanged: function() {
        console.log("🖖 Kapitán hlásí změnu dat v myPlaylist!");

        // 1. Okamžitá aktualizace UI (aby se hned objevila ta "1")
        if (window.populatePlaylist) {
            window.populatePlaylist(window.tracks);
        }

        // 2. Předání informací správci synchronizace
        if (window.PlaylistSyncManager) {
            // Správce hned zjistí, že se hash změnil a nahlásí to
            window.PlaylistSyncManager.updateButtonStatus('warning');
            
            // VOLITELNÉ: Automatické nahrání do cloudu bez klikání
             window.syncPlaylist(); 
        }
    }
};*/
